...
//  VideoPlay
//
//  Created by XiaoFeng on 16/1/19.
...
@property (weak, nonatomic) IBOutlet UIButton *playOrPause;//开始/暂停
...
//    NSString *urlStr=[NSString stringWithFormat:@"http://192.168.1.161/%i.mp4",videoIndex];
    NSString *urlStr = @"http://vplay.aixifan.com/des/20160118/3096587_mkv/3096587_480p.mp4?k=791b2249c2cc761e6f74648331528fdc&t=1453189404";
...
- (IBAction)playClick:(UIButton *)sender {
    ...
    if(self.player.rate==0){ //说明时暂停
        [sender setImage:[UIImage imageNamed:@"btn_pause"] forState:UIControlStateNormal];
//        [sender setImage:[UIImage imageNamed:@"player_pause"] forState:UIControlStateNormal];
        [self.player play];
    }else if(self.player.rate==1){//正在播放
        [self.player pause];
        [sender setImage:[UIImage imageNamed:@"btn_play"] forState:UIControlStateNormal];
